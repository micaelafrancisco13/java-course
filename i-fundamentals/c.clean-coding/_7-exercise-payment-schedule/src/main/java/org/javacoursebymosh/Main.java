...
public class Main {
    ...
    private static void printPaymentSchedule(byte years, int principal, float annualInterest) {
        ...
        while (numberOfPaymentsMade <= (years * MONTHS_IN_YEAR)) {
            double balance = calculateRemainingBalance(principal, annualInterest, years, numberOfPaymentsMade);
    ...
    private static double calculateRemainingBalance(int principal,
